...
camera {
location <1.2*sca,1*sca,1.5*sca>
 look_at <0,0,0>
...
#declare A=<0,0,0>;//base pot
#declare B=<0,0,2>;//haut du pot
#declare C=1;//rayon externe pot
#declare D=0.8;//rayon interne pot 
#declare E=<0,0,0.25>;//fond du pot
#declare F=<0,0,2.01>;//haut du creux du pot
#declare G=<0,0,5>;//base premier cone sapin
#declare H=<0,0,0>;
